...
class Scanner:
    ...
    The Scanner class receives a string of code, make lexical analysis and returns a
    token stream.
    """
    ...
    def skip_ignored(self):
        """
        Skip ignored characters and comments until a non-ignored character or
        END_OF_FILE is found.
        """
        while not self.is_eof():  # While don't reach the end of the string
            ...
            if self.get_char() == "/":  # Skip line comments
                # Checking the slashes separately to avoid checking out of range and
                # IndexError.
    ...
    def scan_lexeme(self) -> str:
        """
        Form a lexeme by reading characters until a symbol or an ignored character is
        found.
        """
        lexeme = ""
    ...
    def get_token(self) -> Token:
        ...
        # Check if the character can be the start of a word.
            ...
            # Check if the lexeme is a valid identifier (may optionally start with @ for
            # HTS comps)
